# Branch B 1943H2 year-end settlement v002

status: AUTHORITATIVE_CURRENT_BRANCH_SETTLEMENT_GALVANIC_FINAL_PROPAGATED
...
- `BENGAL_ARAKAN_CHITTAGONG_1943-10_12_SETTLEMENT_v001.md`
- `GALVANIC_BRANCH_B_1943-11_SETTLEMENT_v002.md`
...
The detailed dependency reopened by v028 is now closed under `GALVANIC_BRANCH_B_1943-11_SETTLEMENT_v002.md`.

US GALVANIC-equivalent D-Day is 1943-11-24. Makin organized resistance ends on 11/27; Tarawa organized resistance ends on 11/28. The United States wins the Gilberts but pays a materially higher fast-carrier price than historical while failing to destroy the surviving Japanese fleet-carrier core.
...
Tarawa final US casualty working band is about 1,900-2,300 total (KIA/MIA 550-700; WIA 1,350-1,650). The old 4,500-4,700 Japanese 'combat' count is superseded: first-line combat is about 2,600-2,900, with another 700-1,000 limited armed-support personnel and the remainder construction/air-ground/labor/support.
...
Repair/regeneration authority: `GALVANIC_DAMAGE_REPAIR_REGEN_LEDGER_1943-11_1944Q1_v001.json`.
Aircraft lessons authority: `GALVANIC_AIRCRAFT_AFTER_ACTION_LESSONS_1943-12_v001.md`.

## 2. Bengal / Arakan

The Japanese operation begins 1943-10-28 as an overland northward Arakan advance supported by sea logistics, short coastal transplants and rotating old-battleship bombardment. It is not a one-shot Chittagong amphibious landing.

Major settled milestones:
- Teknaf captured ~11/05.
- Ukhia captured ~11/14..15.
- Cox's Bazar captured 11/21; Gate B GREEN.
- Dohazari captured ~12/05..06 after British planned withdrawal and a short coastal insertion.
- Chittagong captured evening 12/15; Gate C GREEN.

The British field army is **not** annihilated. 5th and 26th Indian Divisions withdraw north; 7th Indian Division escapes east/northeast with most personnel but much heavy equipment abandoned. 81st West African Division main body is not retroactively trapped in the Kaladan and remains a relatively fresh Feni/Comilla/Hill Tracts reserve.

Japanese 55th Division ends the campaign exhausted. 54th Division advance/rear/logistics elements increasingly relieve security functions but the full division is not conjured into early-November combat.
...
Japanese recovery ladder remains conditional on repair and air defense. By year-end Patenga can support a regular 15-25 fighter/recon presence, with short surges above that possible. Port throughput grows from roughly 100-200 t/day small-craft scale in the first week toward roughly 300-500 t/day late December if repair/air conditions cooperate.
