...
def main():
    ...
    if not a.checkpoint and cp.get('checkpoint_id')!='CHECKPOINT_1943-09-30T24_v003': raise SystemExit('current registry/index did not resolve to synchronized 1943 restart')
